    ...
    <section id ="programs" className="py-16 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Link href="/youth" className="group">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col cursor-pointer transition hover:shadow-2xl hover:ring-2 hover:ring-blue-400">
              <div className="relative w-full h-64">
                <Image
                  src="/eng.jpg" 
                  alt="Youth Empowerment"
                  fill
                  className="object-cover group-hover:scale-105 group-active:scale-105 group-focus:scale-105 transition-transform duration-300 ease-in-out"
                />
              </div>
          ...
          <Link href="/digi" className="group">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col cursor-pointer transition hover:shadow-2xl hover:ring-2 hover:ring-blue-400">
              <div className="relative w-full h-64">
                <Image
                  src="/sch1.jpg"
